...
function querySuccess(tx, results) {
    ...
    for (var i=0; i<len; i++){
        ...
        $('#state_list_ul').append('<li><a href="./phototagbardest.html" data-transition="slide" rel="external" onClick="destClicked(\'' + bar.destination + '\')">' + bar.destination + ' - ' + bar.city + '</a></li>');
    }
